                    ...
                    <div class="section-image" data-image="assets/img/bg5.jpg" ;>
                        ...
                        <div class="container">
                            <div class="col-md-4 col-sm-6 ml-auto mr-auto">
                                <form id="searchForm" class="form" method="POST" action="viewCustomerInfo.php">
                                    <div class="card card-login ">
                                        <div class="card-header ">
                                            <h3 class="header text-center">Search</h3>
                                        </div>
                                        <div class="card-body ">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Passport No.</label>
                                                    <input name="passport" type="text" placeholder="Passport No." class="form-control">
                                                </div>
                                        ...
                                        <div class="card-footer ml-auto mr-auto">
                                            <button type="submit" class="btn btn-warning btn-wd">Search</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    $("#searchForm").submit(function (event) {
        ...
        if (passport == '' && lastName == '') {
            swal({
                ...
                text: "Use any of the input fields!",
                timer: 1000,
