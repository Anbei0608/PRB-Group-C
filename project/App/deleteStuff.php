            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo"> Delete Staff </a>
                    </div>
                                    ...
                                    <form class="form" method="" action="">
                                        <div class="card ">
                                            <div class="card-header ">
                                                <div class="card-header">
                                                    <h4 class="card-title">Delete Staff</h4>
                                                </div>
                                            </div>
                                            <div class="card-body ">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach($data as $v){
                                                                ...
                                                                echo '<td style="text-transform:uppercase">'.$v->type.'</td>';
                                                                echo '
                                                                <td class="td-actions text-right">
                <button onclick="deleteUser('.$v->id.')" type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm">
...
<script>
    function deleteUser(id){
        swal({
                title: "Are you sure?",
                text: "User will be deleted and cannot recover again!",
                type: "warning",
